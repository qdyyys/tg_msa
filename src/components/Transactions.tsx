    ...
    <div className="overflow-auto h-full pb-16">
      <div className="font-SFProDisplay500">
        ...
        <div className="flex flex-col items-center px-4 gap-5">
          <div className="w-full animate-showOp bg-white drop-shadow-contOp rounded-xl bg-tg-theme-bg-color text-tg-theme-text-color">
            <div className="h-36  py-3 px-4 flex gap-8 h-max pb-14 text-tg-theme-text-color">
